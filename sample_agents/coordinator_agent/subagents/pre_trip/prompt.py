...
class PackingList(BaseModel):
    """Schema for a packing list."""
    items: List[str] = Field(default_factory=list, description="List of items to pack for the trip")
...
suggests items to pack appropriate for the trip.

Return in JSON format that includes an 'items' field with an array of packing items, e.g.

{
  "items": ["walking shoes", "fleece", "umbrella"]
}

Make sure to return a valid JSON object with the 'items' field containing an array of strings.
"""
